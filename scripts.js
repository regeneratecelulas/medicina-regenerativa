...
//floating whatsapp icon
    ...
    const servicesData = [
        { icon: 'fa-solid fa-pills', title: 'Certificaciónes Médicas', fecha: "Ya realizado", lugar: "Hotel Baruk, GDL", description: 'Certificación en medicina regenerativa y estética con aval curricular. Pregunta por nuestra próxima certificación modalidad presencial y online.', ponente: 'Varios Expertos', imageUrl: 'celulasimages/service0.jpg', linkZoom: ''},
